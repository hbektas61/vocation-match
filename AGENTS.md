# Vocation Match — Codex Studio Project Instructions

This repository is a Codex Studio project. Read the global Studio playbook and all `.studio/` files before substantive work.
