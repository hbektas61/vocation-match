...
const styles = StyleSheet.create({
  ...
  heroBadgeGlyph: { fontFamily: fontFamily.bodySemi, fontSize: font.label, color: color.onInverse },
  heroBadgeText: { fontFamily: fontFamily.bodySemi, fontSize: font.label, color: color.onInverse },
  heroText: { position: 'absolute', left: 18, right: 18, bottom: 14, gap: spacing.xs },
  heroName: {
  ...
  heroAttribution: { fontFamily: fontFamily.body, fontSize: font.label, color: color.onPhoto },
  plainHead: { gap: spacing.xs },
  plainName: {
    fontFamily: fontFamily.display,
    fontSize: font.title,
    lineHeight: font.title * leading.tight,
  ...
  choiceText: { flex: 1, gap: spacing.tight },
  choiceTitle: {
  ...
  roomHead: { flexDirection: 'row', alignItems: 'center', gap: spacing.snug },
  roomTitle: {
    fontFamily: fontFamily.displaySemi,
    fontSize: font.body,
    lineHeight: font.body * leading.snug,
  ...
  withdrawText: {
    ...
    lineHeight: font.control * leading.snug,
    color: color.danger,
  },
  ...
  /** The one card that keeps an edge: it is asking a destructive question. */
  confirmCard: {
    borderRadius: radius.xl,
    borderWidth: 1.5,
