...
export const en = {
  ...
  onboarding: {
    ...
    promise: {
      ...
      body: 'CheckMatches is for people 18 or older. By continuing you confirm you are at least 18.',
      points: [
  ...
  phoneAuth: {
    ...
    tooLong: 'That number is too long. Check the country code.',
  ...
  venue: {
    ...
    lastUsedHere: 'you were here last',
    ...
    destinationTitle: 'City or region',
    ...
    venueTitle: (name: string) => `Your place in ${name}`,
    venueLabel: 'Search places',
    venuePlaceholder: 'Type the place’s name',
    venueNoResults: 'Nothing by that name in this area.',
    venuePrompt: 'Type the name of your hotel.',
    chipAll: 'All vacation places',
    chipStay: 'Hotels',
    broaderSearchBody:
      'Beach clubs, named beaches and resorts Google does not class as hotels appear under “All vacation places” — no type filter runs there.',
    confirmPromiseTitle: 'Same place = same room',
    confirmPromiseBody:
